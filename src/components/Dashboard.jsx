...
const mockAvailablePolicies = [
  {
    ...
    premium: 350,
    coverage: 100000,
    features: ['Emergency Care', 'Prescription Coverage', 'Dental', 'Vision']
  },
  {
    id: 4,
    type: 'life',
  ...
  },
  {
    id: 5,
    type: 'auto',
    name: 'Auto Insurance Premium Plus',
    description: 'Enhanced auto coverage with roadside assistance',
    premium: 1500,
    coverage: 75000,
    features: ['Comprehensive', 'Collision', 'Roadside Assistance', 'Rental Car']
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600">{mockUserPolicies.length}</p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">
                  ${mockUserPolicies.reduce((sum, policy) => sum + policy.coverage, 0).toLocaleString()}
                </p>
              </div>
            </div>
          </div>
          ...
          <button
            ...
            className="bg-orange-500 hover:bg-orange-600 text-white p-6 rounded-xl shadow-sm transition-colors group"
          >
            <div className="flex items-center space-x-3">
              ...
              <div className="text-left">
                ...
                <p className="text-orange-100 text-sm">File a new claim</p>
              </div>
            </div>
          </button>
        </div>
                ...
                <div key={policy.id} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    <div>
                      ...
                      <p className="font-semibold text-gray-900">${policy.coverage.toLocaleString()}</p>
                    </div>
                    <div>
                ...
                <div key={policy.id} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold text-green-600">${policy.premium}</span>
                    </div>
                  </div>
